...
<?php $__env->startSection('title', 'Export Data - Smart Medical Inventory'); ?>
<?php $__env->startSection('page-title', 'Export Data Center'); ?>
            ...
            <div class="card" style="border: 2px solid var(--border-color);">
                ...
                <div class="card-body">
                    ...
                    <div style="display: flex; gap: 0.5rem; margin-top: 1rem;">
                        <form action="<?php echo e(route('export.pdf')); ?>" method="POST" style="flex: 1;">
                            <?php echo csrf_field(); ?>
                        ...
                        <form action="<?php echo e(route('export.csv')); ?>" method="POST" style="flex: 1;">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="type" value="inventory">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smartmedicalinventory\resources\views/export/index.blade.php ENDPATH**/ ?>